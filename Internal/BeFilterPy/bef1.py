...
folder_name = "W:/Taipan/data/example/"
data_folder = "Norm_data/"
...
#         df_single = pd.read_csv(directory_name+i, skiprows=0, delim_whitespace=True, header=None, names = head_names) #Depending on data file structure, may need to skip metadata of 19 rows
        df_single = pd.read_csv(directory_name+i, skiprows=19, sep='\s+', header=None, names = head_names) #Depending on data file structure, may need to skip metadata of 19 rows
...
# 
# EMPTY_PG_FILES = ["83901_1.xys", "83901_28.xys"]
# EMPTY_Cu_FILES = ["83905_0.xys", "83905_24.xys"]

#Now I import the files associated with a particular measurement.\n",
SAMPLE_PG_FILES = ["95661.xys", "95662.xys", "95663.xys"]
SAMPLE_Cu_FILES = ["95665.xys", "95666.xys", "95667.xys"]

#Of course, the associated background scans must be loaded in as well.\n",
EMPTY_PG_FILES = ["95684.xys", "95679.xys", "95680.xys"]
EMPTY_Cu_FILES = ["95681.xys", "95682.xys", "95683.xys"]
...
save_folder = folder_name + export_folder
