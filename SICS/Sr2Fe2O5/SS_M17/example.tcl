...
# focus for ef = 14.87
drive avfocus 125 ahfocus 88

#focus for ef = 8.07 meV
ahfocus fixed -1
avfocus fixed -1
drive avfocus 100 ahfocus 130
ahfocus fixed 1
avfocus fixed 1
...
mscan s1 57.5 0.2 s2 -68.98 0.4 21 time 1
mscan qh 0 0 qk 1.93 0.01 ql 0 0 14 time 1
mscan qh 3.8 0.04 qk 0 0 ql 0 0 11 time 1
# for 8.07 meV
mscan qh 3.85 0.02 qk 0 0 ql 0 0 16 time 1
...
runscan dummy_motor 1 9 1001 time 5
...
set stop [expr $s1p +2]
runscan $start $stop 41 time 5

m2 absenc
m2 send mg_tp`
mhfocus send m`g4095&_tp`
