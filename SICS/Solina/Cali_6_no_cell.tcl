...
title No cell. Steel plates before & behind sample, Substrate peak MgO (002)
drive s2 -67.66
...
broadcast 6: Remove steel plate, install polariser, install steel plate. Then run Cali_7.
