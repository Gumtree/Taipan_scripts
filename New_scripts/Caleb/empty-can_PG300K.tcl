sampletitle empty V can 8 mm PG 300K 
#
...
#runscan ei 45.6 27 47 time 5 datatype {HISTOGRAM_XYT RAW_TOTAL_HISTOGRAM_XE}
runscan ei 26.8 9 90 time 5 datatype {HISTOGRAM_XYT RAW_TOTAL_HISTOGRAM_XE}
#4.25 hours
drive ei 14.87
#
