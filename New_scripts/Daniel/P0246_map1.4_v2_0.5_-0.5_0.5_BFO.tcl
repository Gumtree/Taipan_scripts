# 23 January 2024
# Map 1.4, 0.5 -0.5 0.5 BFO centered approx
# this map is fine (peaks should be clean ellipses) due to alignment on "this side" (+ve frame)
# v2 of this file: the PG filter on source side has been removed

drive qh 0.5 qk -0.5 ql 0.5

#8
drive qh 0.4965 qk -0.4965
runscan ql 0.478 0.508 21 monitor 400000
