...
#E Scan (0 0 8) TA [001] 200K

# 0.1
# title (0.1 0.1 8) E-scan
# mscan qh 0.1 0 qk 0.1 0 ql 8 0 en -2 0.2 31 monitor 75000

# 0.15
# title (0.15 0.15 8) E-scan
# mscan qh 0.15 0 qk 0.15 0 ql 8 0 en -2 0.2 31 monitor 150000
...
# mscan qh 0.5 0 qk 0.5 0 ql 8 0 en -4.6 0.2 15 monitor 150000

# 0.3
# title (0.3 0.3 8) E-scan
# mscan qh 0.3 0 qk 0.3 0 ql 8 0 en 1.5 0.2 11 monitor 150000

# 0.4
# title (0.4 0.4 8) E-scan
# mscan qh 0.4 0 qk 0.4 0 ql 8 0 en 1.7 0.2 14 monitor 250000

# 0.5
title (0.5 0.5 8) E-scan
mscan qh 0.5 0 qk 0.5 0 ql 8 0 en 2.1 0.2 17 monitor 300000

# 0.6
# title (0.6 0.6 8) E-scan
# mscan qh 0.6 0 qk 0.6 0 ql 8 0 en 1.4 0.2 19 monitor 300000
...
mscan qh 0 0 qk 0 0 ql 7.5 0.025 en 2 0 4 monitor 150000
